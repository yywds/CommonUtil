...
import com.example.studyinfo.Adapter.ShoucangAdapter;
...
public class ShoucangActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CommonUtils.PostHttpValue("name",NameInfo,AppNetConfig.SetShoucangUrl);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapter = new ShoucangAdapter(ShoucangActivity.this, datas);// 实例化Adapter对象(注意:必须要写在在getDatas() 方法后面,不然datas中没有数据)
            }
        }, 1000);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //创建一个意图
                Intent intent = new Intent(ShoucangActivity.this, DetialWords.class);
                ...
                ShoucangActivity.this.startActivity(intent);//启动Activity
            }
        });
    ...
    public void getDatas(String url) {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(url, null,
            ...
            public void onErrorResponse(VolleyError volleyError) {
                DialogShow(ShoucangActivity.this,"空空如也");
                   }
        }
        );
