...
import static com.example.studyinfo.Utils.CommonUtils.PostHttpValue;
...
public class ShengciFuxiActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PostHttpValue("username", NameInfo, AppNetConfig.SetshengcifuxiUrl);
        //延迟获取数据才能正常刷新Listview
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                datas = new ArrayList<Words>();
                getDatas(AppNetConfig.GetshengcifuxiUrl); //读取生成的json数据
                adapter = new BeidanciAdapter(ShengciFuxiActivity.this, datas);// 实例化Adapter对象(注意:必须要写在在getDatas() 方法后面,不然datas中没有数据)
    ...
    public void getDatas(String url) {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            JSONArray jsonArray = jsonObject2.getJSONArray("shengcifuxi");
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                data.setInstance(item.getString("instance"));
                                    ...
                                    Fayin(ShengciFuxiActivity.this, data.getName());//单词发音
                                    name.setText("点我查看单词");
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                DialogShow(ShengciFuxiActivity.this,"生词复习任务\n\n已完成");
                YanChi(ShengciFuxiActivity.this,MainActivity2.class);
        ...
        switch (view.getId()) {
            case R.id.renshi:
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        PostHttpValue("username", NameInfo, AppNetConfig.SetshengcifuxiUrl);
                        IntentToPage(ShengciFuxiActivity.this,IntentActivit3.class);
                        finish();
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        DBHelper.UpdateMyWordsShengci(names,NameInfo);//更新单词
                        Looper.prepare();
                        Toast.makeText(ShengciFuxiActivity.this, "认识", Toast.LENGTH_SHORT).show();
                        Looper.loop();
                    }
                }).start();
                break;
            case R.id.soucang:
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Looper.prepare();
                        Toast.makeText(ShengciFuxiActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
                        Looper.loop();
                    }
                }).start();
                break;
            case R.id.burenshi:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        Looper.prepare();
                        Toast.makeText(ShengciFuxiActivity.this, "不认识", Toast.LENGTH_SHORT).show();
                        Looper.loop();
                    }
                }).start();
                break;
            ...
            case R.id.name:
                ...
                break;
            case R.id.bofang:
                Fayin(ShengciFuxiActivity.this, names);//单词发音
                break;
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        IntentToPage(ShengciFuxiActivity.this,MainActivity2.class);
    }
}
