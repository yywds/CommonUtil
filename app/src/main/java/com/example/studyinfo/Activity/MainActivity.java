...
import com.example.studyinfo.Fragment.FirstFragment;
    ...
    private void init() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                beginTransaction.replace(R.id.ll_layout, new FirstFragment());//初始化显示单词页面
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
                case R.id.tab_rel_home_s:
                    beginTransaction.replace(R.id.ll_layout, new FirstFragment());
