...
public class BeidanciActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beidanci);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                //解决getCacheDir()报空问题
                    ...
                    adapter = new BeidanciAdapter(BeidanciActivity.this, datas);// 实例化Adapter对象(注意:必须要写在在getDatas() 方法后面,不然datas中没有数据)
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //创建一个意图
                Intent intent = new Intent(BeidanciActivity.this, ShowWords.class);
                ...
                BeidanciActivity.this.startActivity(intent);//启动Activity
            }
        });
    ...
    public void Post() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                client.post(AppNetConfig.SetBeidanciUrl, params, new AsyncHttpResponseHandler() {
                    @Override
    ...
    public void getDatas(String url) {
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(url, null,
            ...
            public void onErrorResponse(VolleyError volleyError) {
                WaitDialog.show(BeidanciActivity.this, "数据加载中...");
            }
