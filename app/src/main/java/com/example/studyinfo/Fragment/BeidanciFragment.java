...
import com.example.studyinfo.Activity.BeiActivity;
import com.example.studyinfo.Activity.Setting;
...
import static com.example.studyinfo.Utils.CommonUtils.FangWeixinDialog;
...
public class BeidanciFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //Post请求---后端
        PostHttpValue2("type",CihuiInfo,"name",NameInfo,AppNetConfig.PostInfoUrl);
        PostHttpValue2("name", NameInfo, "time", CurrentTime(), AppNetConfig.PostmycountUrl);
