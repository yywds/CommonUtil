...
public class MeiwenAdapter extends BaseAdapter {
    ...
    private List<Meiwen> datas = new ArrayList<Meiwen>();//新闻列表集合
    ...
    public MeiwenAdapter(Context context, List<Meiwen> datas) {
        this.datas = datas;
...
//        this.layoutInflater2 = LayoutInflater.from(context);
    ...
    @Override
    public Meiwen getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.meiwenshow, null);//找到布局文件
    ...
    private void initViews(Meiwen data, ViewHolder holder, int position) {//初始化数据
        ...
        holder.tvMiaoshu.setText(data.getContent()); //Content
    }
    protected class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            tvMiaoshu = (TextView) view.findViewById(R.id.tv_content);
        }
    }
}